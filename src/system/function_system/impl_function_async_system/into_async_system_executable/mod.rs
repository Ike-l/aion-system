macro_rules! impl_async_system_on_function_system {
    (
        ...
        impl<F, Fut, $($params: Injection),*> AsyncSystemExecutable for FunctionSystemBase<($($params,)*), F>
            where
                ...
                Box::pin(async move {
                    ...
                    $(
                        let $params = {
                            ...
                            let mut access_builders: Vec<AccessBuilder> = vec![program_details.clone().into_access_builder()];
...
macro_rules! impl_all_async_system_on_function_system {
    () => {
        ...
        pub use crate::prelude::{FunctionSystemBase, AsyncSystemExecutable, SystemResult, SystemError, ProgramDetails};
        use hecs::Entity;
